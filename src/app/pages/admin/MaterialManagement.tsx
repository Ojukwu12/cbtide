...
import { z } from 'zod';
import { Upload, FileText, Loader2, Plus, X, Check, Sparkles, AlertCircle, CheckCircle, Clock, Layout as LayoutIcon } from 'lucide-react';
...
export function MaterialManagement() {
  ...
  const generateQuestionsMutation = useMutation({
    mutationFn: ({ courseId, materialId, mode }: { courseId: string; materialId: string; mode: 'ai' | 'ocr' }) =>
      materialService.generateQuestions(courseId, materialId, mode),
    onSuccess: () => {
    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">Upload and manage study materials for courses</p>
        </div>
              ...
              {materials.map((material: any) => (
                <div key={material.id} className="flex items-center justify-between p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      onClick={() => generateQuestionsMutation.mutate({ courseId: selectedCourse, materialId: material.id, mode: generationMode })}
                      disabled={generateQuestionsMutation.isPending}
