      ...
      <div className="space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          <div className="bg-white rounded-xl border border-gray-200 p-6">
            ...
            <h3 className="text-2xl font-bold text-gray-900 mb-1">{performanceTrend && performanceTrend.length > 0 ? Number(performanceTrend[performanceTrend.length - 1]?.score).toFixed(1) : '0.0'}%</h3>
                ...
                strongAreas.map((area, index) => (
                  <div key={index}>
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <span className="text-sm font-bold text-green-600">{area?.averageScore !== undefined && area.averageScore !== null ? Number(area.averageScore).toFixed(1) : '0.0'}%</span>
                    </div>
              ...
              {weakAreas && weakAreas.length > 0 ? (
                weakAreas.map((area, index) => (
                  <div key={index}>
                    <div className="flex items-center justify-between mb-2">
                      <span className="text-sm font-medium text-gray-900">{area.topicName}</span>
                      <span className="text-sm font-bold text-red-600">{area?.averageScore !== undefined && area.averageScore !== null ? Number(area.averageScore).toFixed(1) : '0.0'}%</span>
                    </div>
                    <div className="w-full h-2 bg-gray-100 rounded-full overflow-hidden">
                      <div 
